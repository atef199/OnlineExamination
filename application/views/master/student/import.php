<div class="box">
    ...
    <div class="box-body">
        <ul class="alert alert-info" style="padding-left: 40px">
            ...
            <li>For Class data, it can only be filled using Class ID. <a data-toggle="modal" href="#levelId" style="text-decoration:none" class="btn btn-xs btn-primary">View ID</a>.</li>
        </ul>
                            ...
                            <?php
                                ...
                                if (empty($import)) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="<?= $data['level_id'] == null ? 'bg-danger' : ''; ?>">
                                            <?= $data['level_id'] == null ? 'NOT FILLED' : $data['level_id'];; ?>
                                        </td>
                                    </tr>
                            <?php
                                        if ($data['nim'] == null || $data['nama'] == null || $data['email'] == null || $data['jenis_kelamin'] == null || $data['level_id'] == null) {
                                            $status = false;
                                        }
                                    endforeach;
                                }
...
<div class="modal fade" id="levelId">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table id="level" class="table table-bordered table-condensed table-striped">
                    <thead>
                        <th>ID</th>
                        <th>Class</th>
                        <th>Dept</th>
