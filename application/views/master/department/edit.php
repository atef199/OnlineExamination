                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <?=form_hidden('dep_id['.$no.']', $j->dep_id)?>
                                    <input autofocus="autofocus" onfocus="this.select()" autocomplete="off" value="<?=$j->dep_name?>" type="text" name="dep_name[<?=$no?>]" class="input-sm form-control">
