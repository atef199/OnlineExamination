    ...
    columnDefs: [
      {
        ...
        render: function(data, type, row, meta) {
          ...
          if (data.ada > 0) {
            ...
            btn = `<button data-id="${data.std_id}" type="button" class="btn btn-xs btn-primary btn-aktif">
								<i class="fa fa-user-plus"></i>Activate
							</button>`;
          }
          return `<div class="text-center">
									<a class="btn btn-xs btn-warning" href="${base_url}student/edit/${data.std_id}">
